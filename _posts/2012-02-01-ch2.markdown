...
The Internet layer lets us communicate across the world and the transport layer
makes sure that our data will get to where we want, but what data are we
actually sending? Well... anything!
