...
input + algorithm + computer &rarr; metacomputer &rarr; answer
...
input + algorithm + computer algorithm &rarr; metacomputer &rarr; answer
...
new input + computer algorithm &rarr; metacomputer &rarr; answer
...
compute any other computer), we call it **Turing complete**. "Complete" is a
good word to use here because once a machine is Turing complete it's basically
done - we don't need to make it any more complex. Any further complexity can be
added by making the computer simulate more complex computers.
</aside>
