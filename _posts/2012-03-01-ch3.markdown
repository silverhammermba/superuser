...
page source". This shows you exactly what HTML your browser is interpreting to
create the page. "Interpreting" is a very important word here since different
people might want to interpret HTML differently. For example a blind person
might use a web browser that interprets HTML into a medium of touch and sound so
that they can still interact with it.
