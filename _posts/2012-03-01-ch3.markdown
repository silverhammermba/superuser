...
* The first entry &ndash; 0x20 &ndash; translates to a space
...
In our case, the anchor "Richard Wilbur" has a "hypertext reference" (`href`) to
a Wikipedia article.
...
2. View the page source of _this_ page; it's written in HTML! Try to match up
   ...
   [gh]: https://raw.githubusercontent.com/silverhammermba/superuser/gh-pages/_posts/2012-03-01-ch3.markdown
