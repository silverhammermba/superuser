...
input and outputs a fixed number of bytes as output and which is very unlikely
to produce the same output given two different inputs. Usually this function
