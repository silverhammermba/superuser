...
computer to another. Let's start with a very simple protocol

1. Send the entire message at once using the following format:
...
This certainly satisfies our basic goal.
