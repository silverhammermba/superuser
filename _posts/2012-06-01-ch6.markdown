...
* New malware programs are frequently released by hackers around the world. Some
  ...
  frequently updated to add new malware to the list of known threats. Thus a
  system can never be _permanently_ secure.
* Some antivirus programs instead try to find programs acting "suspiciously" and
  alert the user to determine whether these are actual threats. This can be
...
&ndash; by far &ndash; is to educate yourself about malware so that you can
avoid getting it on your computer at all.
