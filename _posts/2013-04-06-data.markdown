...
2<sup>64</sup> - 1. But can we really? Real computers have much more memory than
just eight bytes; they can have hundreds of thousands of bytes. With thousands
of bytes around, how do you tell the computer that these eight bytes go
together? One way would be to agree that the first byte says how many bytes
...
use powers of 1024 = 2<sup>10</sup>. In other words
