...
happens if we give it 9 as input? The wheel circles back around to 0!
...
09, turning the handle changes the 9 to 0, which advances the 0 to 1 and we get 10.
Success! If we keep turning, the second wheel remains at 1 (giving us 11, 12,
13, ...) until we get to 19 and it once again advances to 20.
