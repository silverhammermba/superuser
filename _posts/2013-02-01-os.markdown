...
commanding the shell itself to change its working directory &ndash; hence "shell
...
arguments you provided &ndash; which is exactly what happens here with `grep`.
