...
modern OS, but on its own it does basically nothing&mdash;it needs other
...
{: .pull-right}
If your VM window doesn't look like that. Try hitting <kbd>Enter</kbd>.

Also, if you lose your mouse cursor at any point, it's probably because of a
...
**command line** for the way you type commands line-by-line.
{: .definition}
...
<div class="deeper">
There's another time-saving feature of the shell called "globbing" that saves
you time when typing out multiple file names. What if you want to `cat` every
file in `/sys/devices/system/cpu`? You could type them all out
...
<div class="deeper">
Another time-saving feature is autocomplete, which can save you a lot of typing
in general. How it works is when you're typing either the name of a command or a
file path in the shell, you can press <kbd>Tab</kbd> to tell the shell to finish
typing it for you. So instead of typing
