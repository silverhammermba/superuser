...
<img src="{{ site.baseurl }}/img/add1.png" alt="Add 1 Machine"/>
</div>
...
<img src="{{ site.baseurl }}/img/overflow.png" alt="Overflow"/>
</div>
...
<div class="well pull-right">
<img src="{{ site.baseurl }}/img/carry.png" alt="Carrying Digits"/>
</div>
...
we'll just assume that we have lots and lots of wheels - not infinitely many,
...
<div class="well pull-right">
<img src="{{ site.baseurl }}/img/turing.png" alt="Turing machine"/>
</div>
