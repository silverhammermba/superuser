...
what specific instructions it needes. Instead, they include a special I/O
...
* Linux: Linus Torvalds, a computer science graduate student, created this
  kernel in 1991 as a personal project. Through [open source][os] development,
  it has become hugely popular and today is used in every Android
  smart phone among other places.

[os]: {{ site.baseurl }}/part2/security2/#user-error
...
finally look at some of that stuff that get's done, and we'll figure out what
that term "operating system" actually means.
